...
namespace DncZeus.Api.Controllers.Api.V1.Rbac
{
    ...
    public class RoleController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [CustomAuthorize("rbac_role_view")]
        public IActionResult List(RoleRequestPayload payload)
        {
            var response = ResponseModelFactory.CreateResultInstance;
            using (_dbContext)
            {
                var query = _dbContext.DncRole.AsQueryable().AsNoTracking();
        ...
        [CustomAuthorize("rbac_role_create")]
        ...
        [HttpPost]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_role_edit")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_role_delete")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_role_recover")]
        ...
        [HttpGet]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_role_batch")]
        ...
        [CustomAuthorize("rbac_role_permission_assign")]
        ...
        [CustomAuthorize("rbac_user_assign_role")]
