...
namespace DncZeus.Api.Controllers.Api.V1.Rbac
{
    ...
    public class PermissionController : Controller
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [CustomAuthorize("rbac_permision_view")]
        public IActionResult List(PermissionRequestPayload payload)
        {
            var response = ResponseModelFactory.CreateResultInstance;
            using (_dbContext)
            {
                var query = _dbContext.DncPermission.AsQueryable().AsNoTracking();
        ...
        [CustomAuthorize("rbac_permision_create")]
        public IActionResult Create(PermissionCreateViewModel model)
        {
            ...
            using (_dbContext)
            {
                ...
                if (_dbContext.DncPermission.Any(x => x.ActionCode == model.ActionCode))
                {
        ...
        [HttpPost]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_permision_edit")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_permision_delete")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_permision_recover")]
        ...
        [HttpGet]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_permision_batch")]
        ...
        [CustomAuthorize("rbac_role_permission_view")]
...
WHERE P.IsDeleted=0 AND P.Status=1";
                ...
                var permissionList = _dbContext.DncPermissionWithAssignProperty.FromSqlRaw(sql, code).OrderByDescending(x => x.Name).ToList();
