...
namespace DncZeus.Api.Controllers.Api.V1.Rbac
{
    ...
    public class UserController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [CustomAuthorize("rbac_user_view")]
        public IActionResult List(UserRequestPayload payload)
        {
            using (_dbContext)
            {
                var query = _dbContext.DncUser.AsQueryable().AsNoTracking();
        ...
        [CustomAuthorize("rbac_user_create")]
        ...
        [HttpPost]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_user_edit")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_user_delete")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_user_recover")]
        ...
        [HttpGet]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_user_batch")]
