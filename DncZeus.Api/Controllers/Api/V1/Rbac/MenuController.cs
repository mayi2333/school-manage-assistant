...
namespace DncZeus.Api.Controllers.Api.V1.Rbac
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        [CustomAuthorize("rbac_menu_view")]
        public IActionResult List(MenuRequestPayload payload)
        {
            using (_dbContext)
            {
                var query = _dbContext.DncMenu.AsQueryable().AsNoTracking();
        ...
        [CustomAuthorize("rbac_menu_create")]
        ...
        [HttpPost]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_menu_edit")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_menu_delete")]
        ...
        [HttpGet("{ids}")]
        [ProducesResponseType(200)]
        [CustomAuthorize("rbac_menu_recover")]
