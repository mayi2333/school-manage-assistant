...
namespace DncZeus.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(DncZeusDbContext dbContext, IMemoryCache memoryCache)
        {
...
WHERE P.IsDeleted=0 AND P.Status=1";
            ...
            _memoryCache.Remove("CK_PERMISSION_" + AuthContextService.CurrentUser.LoginName);
            return Ok(response);
        }
