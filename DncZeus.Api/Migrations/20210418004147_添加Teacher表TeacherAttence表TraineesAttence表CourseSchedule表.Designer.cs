...
namespace DncZeus.Api.Migrations
{
    ...
    [Migration("20210418004147_添加Teacher表TeacherAttence表TraineesAttence表CourseSchedule表")]
    partial class 添加Teacher表TeacherAttence表TraineesAttence表CourseSchedule表
    {
