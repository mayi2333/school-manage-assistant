...
namespace DncZeus.Api.Migrations
{
    ...
    [Migration("20210629202254_新增试听表和微信模板消息表")]
    partial class 新增试听表和微信模板消息表
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.AuditionCourse", b =>
                {
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.FaceFeature", b =>
                {
                    b.Property<Guid>("Guid")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FaceEncodes")
                        .HasColumnType("varchar(3000)");

                    b.HasKey("Guid");

                    b.ToTable("FaceFeature");
                });
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.Teacher", b =>
                {
                    ...
                    b.Property<Guid?>("FaceFeatureGuid")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("IdCardBindInfo")
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("FaceFeatureGuid")
                        .IsUnique()
                        .HasFilter("[FaceFeatureGuid] IS NOT NULL");
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.TemplateMsg", b =>
                {
                    b.Property<Guid>("Guid")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.Teacher", b =>
                {
                    b.HasOne("DncZeus.Api.Entities.FaceFeature", "FaceFeature")
                        .WithOne("Teacher")
                        .HasForeignKey("DncZeus.Api.Entities.Teacher", "FaceFeatureGuid")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("DncZeus.Api.Entities.Trainees", b =>
                {
                    ...
                    b.HasOne("DncZeus.Api.Entities.FaceFeature", "FaceFeature")
                        .WithOne("Trainees")
                        .HasForeignKey("DncZeus.Api.Entities.Trainees", "FaceFeatureGuid")
                        .OnDelete(DeleteBehavior.SetNull);
                });
